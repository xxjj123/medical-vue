...
var __vite_injected_original_import_meta_url,
  _default,
  viteCommonConfig_default;
var init_viteCommonConfig = __esm({
  "viteCommonConfig.ts"() {
    "use strict";
    __vite_injected_original_import_meta_url =
      "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/viteCommonConfig.ts";
    _default = {
      alias: {
        base: {
          // 框架基础的alias
          ...
          "@projectCommon": fileURLToPath(
            new URL(
              "./cli/projectCommon/src",
              __vite_injected_original_import_meta_url,
            ),
          ),
          faceConfig: fileURLToPath(
            new URL("./faceConfig", __vite_injected_original_import_meta_url),
          ),
          // 将第三方模块指向其对应的ES模块文件
          ...
          "vue-router": {
            find: /^vue-router$/,
            replacement: "vue-router/dist/vue-router.esm.js",
          },
      ...
      cli: {
        ...
        override: {
          ...
          "routes-container":
            "@yh/cli-internal-common/src/components/routesContainer.vue",
          ...
          login: {
            ...
            src: {
              "modify-password":
                "@yh/cli-pages-login/src/part/modifyPassword.vue",
...
function getOpen() {
  ...
  if (viteCommonConfig_default.open) {
    open = `${getEnv("VITE_PUBLIC_PATH")}/${
      viteCommonConfig_default.open
    }`.replaceAll(/\/\//g, "/");
  }
  return open;
}
...
\u8BF7\u68C0\u67E5\u6587\u4EF6: '${filePath}'`);
    ...
    OVERRIDE_PAGES_COMPONENTS = mergeConfig(
      modulePages,
      viteCommonConfig_default.cli.override,
    );
...
async function getInjectCode() {
  ...
  Object.keys(multipleService_config_default.multipleServiceConfig).forEach(
    (k) => {
...
var init_pages = __esm({
  "build-vite/mpa/pages.ts"() {
    ...
    __vite_injected_original_import_meta_url2 =
      "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/build-vite/mpa/pages.ts";
    ({ html: htmlPages, cli } = viteCommonConfig_default);
    ({ modules } = cli);
    __dirname2 = resolve(
      dirname(fileURLToPath2(__vite_injected_original_import_meta_url2)),
      "../../",
    );
...
function copyModulePublic() {
  return glob3
    .sync([
      `${glob3.convertPathToPattern(
        process.cwd(),
      )}/node_modules/@yh/*/public/**`,
    ])
    .map((file) => {
      return {
        from: file,
...
} from "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/node_modules/.pnpm/vite-plugin-virtual-html@1.1.16_@types+node@18.18.0_less@4.2.0_terser@5.21.0/node_modules/vite-plugin-virtual-html/dist/index.mjs";
...
async function readPresetThemePrimaryColor() {
  ...
  for (const theme of presetThemes) {
    if (theme.endsWith(".less")) {
      const lessCode = (
        await fsp.readFile(resolvePresetThemePath(theme))
      ).toString();
...
async function basePlugins(_mode, ignoreHtmlPlugin = false) {
  ...
  const { multipleScopeVars, virtualThemes } =
    await readPresetThemePrimaryColor();
    ...
    ...[
      ...
      uiVite({
        transform(moduleName, camelCase) {
          ...
          if (useSingleCss) {
            styleImporter =
              'import "@yh/cli-internal-precompiled-less/css/ui.css";';
          } else {
          ...
          if (
            useDemandImport2 &&
            [...DEMAND_UI_IMPORT_BLACK_LIST, ...IGNORE_VUE_USE].indexOf(
              camelCase,
            ) < 0
          ) {
            result = `
        ...
        modules: [
          {
            ...
            moduleValue:
              "import { initTheme, } from '@yh/cli-internal-dynamic-theme';initTheme();",
          },
          {
          ...
          },
          {
            ...
            moduleValue: `
          const historyPage = ${JSON.stringify(
            historyPageInjectIntoFaceConfig,
          )};
...
function devPlugins(_mode) {
  ...
  return [
    viteCommonjs({
      include: viteCommonConfig_default.commonjs.include.map((k) =>
        k.replaceAll("**", ""),
      ),
...
async function prodPlugins(_mode) {
  ...
  result.push(
    StringReplace([
      ...
      },
      {
        ...
        replace:
          "new external_commonjs_vue_commonjs2_vue_root_Vue_default.a.default",
      },
    ]),
  );
  if (isEnvTrue("BUILD_INJECT_MODERN_POLYFILLS")) {
    result.push(
      legacy({
        modernPolyfills: await import(
          "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/node_modules/.pnpm/core-js-compat@3.33.0/node_modules/core-js-compat/index.js"
        ).then((d) => {
  ...
  if (isEnvTrue("BUILD_LEGACY") && !isEnvTrue("BUILD_DEMAND_UI_IMPORT")) {
    ...
    const modernPolyfills = await import(
      "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/node_modules/.pnpm/core-js-compat@3.33.0/node_modules/core-js-compat/index.js"
    ).then((d) => {
      return d.default(viteCommonConfig_default.build.polyfills).list;
    });
    ...
    const legacyPolyfills = await import(
      "file:///D:/ai-%E5%8C%BB%E5%AD%A6%E5%BD%B1%E5%83%8F%E9%A1%B9%E7%9B%AE/%E4%BB%A3%E7%A0%81/testCode/ta404ui-152-ct/demo/node_modules/.pnpm/core-js-compat@3.33.0/node_modules/core-js-compat/index.js"
    ).then((d) => {
      return d.default({
    ...
    result.push(
      legacy({
        ...
        modernPolyfills: isEnvTrue("BUILD_INJECT_MODERN_POLYFILLS")
          ? modernPolyfills
          : [],
...
var init_plugin = __esm({
  "build-vite/src/plugin.ts"() {
    ...
    init_src();
    __vite_injected_original_dirname =
      "D:\\ai-\u533B\u5B66\u5F71\u50CF\u9879\u76EE\\\u4EE3\u7801\\testCode\\ta404ui-152-ct\\demo\\build-vite\\src";
    fsp = fs.promises;
...
function defineEnv(_mode) {
  ...
  Object.keys(title).forEach((k) => {
    pageTitles[`import.meta.env.VITE_HTML_TITLE_${k.toUpperCase()}`] =
      `"${title[k]}"`;
  });
  return {
    ...pageTitles,
...
async function optimizeLibs() {
  return (await optimizeEntriesBase())
    .filter((k) => k.indexOf("node_modules") >= 0)
    .map((lib) => {
...
async function optimizeEntries() {
  return (await optimizeEntriesBase()).filter(
    (k) => k.indexOf("node_modules") < 0,
  );
}
...
async function getOptimizeConfig(_mode) {
  ...
  optimizeDeps.exclude = [
    ...viteCommonConfig_default.optimizeDeps.exclude,
    "sw.js",
  ];
...
async function buildDevConfig(mode) {
  ...
  const warmupHtml = Object.keys(htmlEntry)
    .map((k) => {
      const v = htmlEntry[k];
...
init_utils();
async function buildViteConfig({ mode, command, ignoreHtmlPlugin }) {
  let config = {};
  await initEnv(mode);
  if (mode === "development") {
    config = await Promise.resolve()
      .then(() => (init_vite_dev(), vite_dev_exports))
      .then(({ init: init2, buildDevConfig: buildDevConfig2 }) => {
        init2();
        return buildDevConfig2(mode);
      });
  } else if (mode === "preview") {
    config = await Promise.resolve()
      .then(() => (init_vite_preview(), vite_preview_exports))
      .then(({ buildPreviewConfig: buildPreviewConfig2 }) => {
        return buildPreviewConfig2(mode, command);
      });
  } else if (mode === "production") {
    config = await Promise.resolve()
      .then(() => (init_vite_prod(), vite_prod_exports))
      .then(({ buildProdConfig: buildProdConfig2 }) => {
        return buildProdConfig2(mode, ignoreHtmlPlugin);
      });
  } else if (mode === "mock") {
    config = await Promise.resolve()
      .then(() => (init_vite_mock(), vite_mock_exports))
      .then(({ buildMockConfig: buildMockConfig2 }) => {
        return buildMockConfig2(mode);
      });
  } else {
    throw new Error(
      "\u6CA1\u6709\u6307\u5B9A\u4E00\u4E2A\u53EF\u7528\u7684mode,\u8BF7\u5C1D\u8BD5\u901A\u8FC7--mode=***\u6765\u6307\u5B9A",
    );
  }
  return config;
}
