<template>
  <div v-show="szckxButtonState" ref="container">
    ...
    <svg ref="svg" class="absolute select-none pointer-events-none w-full h-full">
      <line :x1="0" :y1="height - data.displayY / screenRatio" :x2="width" :y2="height - data.displayY / screenRatio"
        stroke="#2cf66c" :stroke-width="1.5 / screenRatio" :stroke-dasharray="dashArray"
        vector-effect="non-scaling-stroke" />
      <line :x1="data.displayX / screenRatio" :y1="0" :x2="data.displayX / screenRatio" :y2="height" stroke="#2cf66c"
        :stroke-width="1.5 / screenRatio" :stroke-dasharray="dashArray" vector-effect="non-scaling-stroke" />

      <!-- <line :x1="0" :y1="height - data.crosshair_y / screenRatio" :x2="width"
        :y2="height - data.crosshair_y / screenRatio" stroke="#2cf66c" :stroke-width="1.5 / screenRatio"
        :stroke-dasharray="dashArray" vector-effect="non-scaling-stroke" />
      <line :x1="data.displayX / screenRatio" :y1="0" :x2="data.displayX / screenRatio"
...
export default {
  ...
  methods: {
    ...mapActions("lungToolsStore", ["resizeSliceViews"]),
    detectZoom() {
      let ratio = 1;
