...
import { SortOption, pneumoniaFindingTemplate, pneumoniaDiagnoseTemplate } from "@/assets/js/utils/dicom/select";
    ...
    resultBookItems: {
      get() {
        ...
        if (this.blockMode == 'finding') {
          resultBookItems = pneumoniaFindingTemplate(this.selection, this.current)
          console.log("resultBookItems2---", resultBookItems)
          // return resultBookItems
        } else if (this.blockMode == 'diagnose') {
          resultBookItems = pneumoniaDiagnoseTemplate(this.selection, this.current)
          console.log("resultBookItems2", resultBookItems)
